...
exports.pool:allocateObject(adamaobject)
exports.pool:allocateColshape(adamashape)
...
exports.pool:allocateObject(jackobject)
exports.pool:allocateColshape(jackshape)
...
exports.pool:allocateObject(benobject)
exports.pool:allocateColshape(benshape)
