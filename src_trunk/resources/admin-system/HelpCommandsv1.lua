	...
	if ( (var - 0) == 1) then
	    if ( myWindow == nil ) then
			...
			if (tabChatCommands) then    
				...
				guiGridListSetItemText ( chatcommandslist, whispchatcreaterow, chatcommanduse, "/w <player name/ID> <text>", false, false )
				...
				guiGridListSetItemText ( chatcommandslist, privatemessagechatcreaterow, chatcommanduse, "/pm <player name/ID> <text>", false, false )
				...
				guiGridListSetItemText ( chatcommandslist, icreaterow, chatcommanduse, "/i <text>", false, false )
                ...
                -- elseif (factiontype == 2) then
				    ...
				    guiGridListSetItemText ( factcommandslist, pcreaterow, factcommanduse, "'P' (keyboard bind key [while out of a vehicle])", false, false )
				    ...
				    guiGridListSetItemText ( factcommandslist, arrestcreaterow, factcommanduse, "/arrest <player name/ID> <time (in minutes)> <fine> <charges>", false, false )
				    ...
				    guiGridListSetItemText ( factcommandslist, ncreaterow, factcommanduse, "/n <test>", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, callcreaterow, itemcommanduse, "/call <phone number> (YOU NEED A CELLPHONE)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, hangupcreaterow, itemcommanduse, "/hangup (YOU NEED A CELLPHONE)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, loudspeakercreaterow, itemcommanduse, "/loudspeaker (YOU NEED A CELLPHONE)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, pchatcreaterow, itemcommanduse, "/p <text> (YOU NEED A CELLPHONE)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, pickupcreaterow, itemcommanduse, "/pickup (YOU NEED A CELLPHONE)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, phonebookcreaterow, itemcommanduse, "/phonebook <player name/ID> (YOU NEED A PHONEBOOK)", false, false )
				...
				guiGridListSetItemText ( itemcommandslist, radiofreqcreaterow, itemcommanduse, "/tuneradio <channel mumber 0-65535> (YOU NEED A RADIO)", false, false )
				...
				guiGridListSetItemText ( misccommandslist, toggleooccreaterow, misccommandexplanation, "This command turns the OOC on and off for the player, depending on it's current state.", false, false )
				...
				guiGridListSetItemText ( misccommandslist, dumploadcreaterow, misccommandexplanation, "This command is used to deliver good as part of the delivery job.", false, false )
