...
function usePDDivDoor1(thePlayer)
	...
	if (team==getTeamFromName("Las Venturas Metropolitan Police Department")) then
		...
		if (distance<=10) and (open==false) then
			...
			moveObject(objDivGate1, 1000, 244.9, 72.4765625, 1002.640625, 0, 0, 90)
			moveObject(objDivGate2, 1000, 247.9, 72.4765625, 1002.640625, 0, 0, -90)
