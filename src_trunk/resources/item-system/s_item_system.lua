...
function useItem(itemID, itemName, itemValue, isWeapon, groundz)
	if not (isWeapon) then
		...
		elseif (itemID==8) then -- sandwich
			...
			exports.global:applyAnimation(source, "food", "eat_burger", 1.0, 1.0, 0.0, false, true, true)
		...
		elseif (itemID==9) then -- sprunk
			...
			exports.global:applyAnimation(source, "VENDING", "VEND_Drink_P", 1.0, 1.0, 0.0, false, true, true)
			toggleAllControls(source, true, true, true)
			setTimer(removeAnimation, 4000, 1, source)
