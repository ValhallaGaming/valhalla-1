...
function createSewerFlood()
	...
	-- Water #4
	local x1, y1, z1 = 1357.7431640625, -1868.1962890625, 6 -- SW
	local x2, y2, z2 = 1527.5556640625, -1873.0205078125, 6 -- SE
	local x3, y3, z3 = 1349.453125, -1701.9990234375, 6 -- NW
	local x4, y4, z4 = 1527.1181640625, -1709.41015625, 6 -- NE
	local water = createWater(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4)
	
	-- Water #5
	local x1, y1, z1 = 1574.828125, -1877.42578125, 6 -- SW
	local x2, y2, z2 = 2534.6591796875, -1917.185546875, 6 -- SE
	local x3, y3, z3 = 1576.982421875, -1729.087890625, 6 -- NW
	local x4, y4, z4 = 2537.37890625, -1775.4609375, 6 -- NE
	local water = createWater(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4)
	
	-- Water #6
	local x1, y1, z1 = 2527.25, -2115.4765625, 6 -- SW
	local x2, y2, z2 = 2628.8037109375, -2207.7392578125, 6 -- SE
	local x3, y3, z3 = 2523.50390625, -1468.19140625, 6 -- NW
	local x4, y4, z4 =  2623.529296875, -1452.0751953125, 6 -- NE
	local water = createWater(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4)
	
	
	-- Water #7
	local x1, y1, z1 = 1613.341796875, -1750.46289062, 6 -- SW
	local x2, y2, z2 = 1630.85546875, -1750.1044921875, 6 -- SE
	local x3, y3, z3 = 1609.0078125, -1670.2392578125, 6 -- NW
	local x4, y4, z4 = 1628.3701171875, -1672.7763671875, 6 -- NE
	local water = createWater(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4)
	
	-- Water #8
	local x1, y1, z1 = 1966.9541015625, -1942.3779296875, 6 -- SW
	local x2, y2, z2 = 2076.99609375, -1927.4052734375, 6 -- SE
	local x3, y3, z3 = 1960.7197265625, -1872.1435546875, 6 -- NW
	local x4, y4, z4 = 2075.8251953125, -1866.0732421875, 6 -- NE
	local water = createWater(x1, y1, z1, x2, y2, z2, x3, y3, z3, x4, y4, z4)
end