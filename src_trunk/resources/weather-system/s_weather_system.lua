...
function getWeatherType(thePlayer, command)
	outputChatBox("The weather is currently: "..weather, thePlayer)
end
...
function manualChangeWeatherType(thePlayer, weathertype)
	...
	weathertype == "fog" ) then
		...
		outputChatBox("Weather changed to: "..weathertype, thePlayer, 0, 255, 0, true)
		
		local hiddenAdmin = getElementData(thePlayer, "hiddenadmin")
			
		if (hiddenAdmin==0) then
			local adminTitle = exports.global:getPlayerAdminTitle(thePlayer) -- Gets the title such as "Alpha Admin", etc
			exports.global:sendMessageToAdmins("AdmCmd: "..tostring(adminTitle).." "..getPlayerName(thePlayer).." has changed the weather to " .. weather .. ".")
		end
