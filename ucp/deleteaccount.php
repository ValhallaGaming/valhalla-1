			      ...
			      <tr>
                    ...
                    <?php 
						...
						else
						{
							...
							if ($appstate != 0)
							{
								echo "This account can not be deleted as it has activity.";
							}
							elseif ($admin > 0)
							{
								echo "This account can not be deleted as it is an administrator account.";
							}
							else
							{
								mysql_query("DELETE FROM accounts WHERE id='" . $userid . "' LIMIT 1", $conn);
